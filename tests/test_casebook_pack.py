"""Regression checks for the beacon-trace-incident-grid casebook."""
...
from casebook.harness import assert_expected, beacon_trace_incident_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_trace_incident_grid_summary(), assert_expected())
