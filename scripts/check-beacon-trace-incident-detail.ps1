...
$repo = "beacon-trace-incident-grid"
$language = "Scala"
$category = "Observability"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/beacon-trace-incident-walkthrough.md")) {
